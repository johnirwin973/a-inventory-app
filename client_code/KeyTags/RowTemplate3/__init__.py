...
class RowTemplate3(RowTemplate3Template):
    ...
    def update_subtotal(self):
        ...
        for row in rows:
            if row['Item_number'] == item_number:
                ...
                if cost is not None and quantity_text and int(quantity_text) > 0:
    ...
    def update_button_click(self, **event_args):
        ...
        if quantity_text:  # Check if the text is not None and not blank after removing leading/trailing whitespace
